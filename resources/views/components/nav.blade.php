          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-link href="/" :active="request()->is('/')">Dashboard </x-link>
                <x-link href="/course" :active="request()->is('course')">Course </x-link>
                <x-link href="/mylisting" :active="request()->is('mylisting')">Listing</x-link>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
